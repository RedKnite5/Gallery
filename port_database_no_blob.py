...
con_old = sqlite3.connect("secrets_and_data/database.db")
cur_old = con_old.cursor()


cur_old.execute(
	"SELECT filename, time, description FROM media"
)
...
con = sqlite3.connect("secrets_and_data/database_no_blob.db")
cur = con.cursor()
